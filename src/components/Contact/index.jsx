...
export default function Contact() {
  ...
  return (
    <motion.div id="contacto" className="contact" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} transition={{ duration: 0.7 }}>
      ...
      <div className="contact__socials">
        {socials.map(({ icon, label, href, external }) => (
          <a key={label} href={href} {...(external ? { target: "_blank", rel: "noreferrer" } : {})} className="contact__social-btn">
